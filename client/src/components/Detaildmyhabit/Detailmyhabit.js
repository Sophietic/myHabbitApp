    ...
    <div className="columns is-centered">
      ...
      <div className="card">
        <div className="card-content" key={habitDetailState._id}> 
          ...
          <p className="content"><strong>Healthy Habit:</strong>Try to meditate the first thing in the morning just for just one minute. If morning just isn’t convenient for you, I’d recommend choosing a specific time you have free every day—your lunch break, for instance. You might switch it up sometimes, but having meditation regularly built into your daily schedule helps a lot.</p>  
          <p className="content"><strong>Current streak:</strong> </p>  
          <p className="content"><strong>Longest streak:</strong> </p>  
          <p className="content"><strong>Within current streak:</strong> </p>  
